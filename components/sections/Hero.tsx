...
export default function Hero() {
  return (
    <section className='relative isolate h-screen'>
      <div className='mx-auto max-w-sm h-full flex flex-col items-center justify-center'>
        ...
        <div className='text-center'>
          ...
          <p className='mt-6 text-xl font-semibold leading-8 text-gray-700 lg:whitespace-nowrap dark:text-slate-300'>
            I&apos;m a full-stack dev, specialized in dashboard UIs.
          </p>
          <p className='mt-6 text-md leading-8 text-gray-600 mx-auto max-w-[40ch] dark:text-slate-400'>
          ...
          <div className='mt-10 flex items-center justify-center gap-x-4'>
            ...
            <Link
              href='/#more'
              className='bg-slate-50 text-sm font-semibold text-slate-800 px-4 py-2.5 rounded-md ring-1 ring-blue-100 hover:ring-blue-200 dark:ring-blue-900 dark:hover:ring-blue-800 dark:text-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700'
            >
              Learn more
            </Link>
          </div>
      ...
      <div
        className='absolute left-0 top-0 -z-20 transform-gpu overflow-hidden blur-3xl sm:-top-32'
        aria-hidden='true'
      >
        <div
          className='relative left-[calc(100%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-red-100 to-orange-100 opacity-50 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem] dark:from-teal-900 dark:to-blue-900 dark:opacity-20'
          style={{
            clipPath:
      ...
      >
        <div
          className='relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-amber-100 to-yellow-100 opacity-50 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem] dark:from-emerald-900 dark:to-blue-900 dark:opacity-20'
          style={{
            clipPath:
              'polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)',
          }}
