  ...
  return (
    <div className='w-screen'>
      <section className='relative isolate px-6 pt-14 lg:px-8 h-screen'>
        ...
        <div className='mx-auto max-w-sm py-12 sm:py-24 lg:py-32 lg:max-w-lg'>
          ...
          <div className='text-center'>
            ...
            <p className='mt-6 text-xl font-semibold leading-8 text-gray-700'>
              I&apos;m a full-stack dev, specialized in dashboard UIs.
            </p>
            <p className='mt-6 text-md leading-8 text-gray-600 mx-auto'>
            ...
            <div className='mt-10 flex items-center justify-center gap-x-6'>
              ...
              <Link
                href='/#more'
                className='bg-slate-50 text-sm font-semibold text-slate-800 px-4 py-2.5 rounded-md ring-1 ring-slate-900/10 hover:ring-slate-900/20'
              >
                Learn more
              </Link>
            </div>
      ...
      >
        ...
        <div className='h-80 min-h-full bg-white ring-1 ring-slate-200 rounded-md p-4'>
          <LineChart />
        </div>
      </section>
      <section
